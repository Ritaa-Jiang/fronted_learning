...
[ JavaScript 教程](https://wangdoc.com/javascript/index.html)[DOM](https://wangdoc.com/javascript/dom/index.html)[CSS 操作](https://wangdoc.com/javascript/dom/css.html)
...
- [HTML 元素的 style 属性](https://wangdoc.com/javascript/dom/css#html-元素的-style-属性)
- CSSStyleDeclaration 接口
  - [简介](https://wangdoc.com/javascript/dom/css#简介)
  - [CSSStyleDeclaration 实例属性](https://wangdoc.com/javascript/dom/css#cssstyledeclaration-实例属性)
  - [CSSStyleDeclaration 实例方法](https://wangdoc.com/javascript/dom/css#cssstyledeclaration-实例方法)
- [CSS 模块的侦测](https://wangdoc.com/javascript/dom/css#css-模块的侦测)
- CSS 对象
  - [CSS.escape()](https://wangdoc.com/javascript/dom/css#cssescape)
  - [CSS.supports()](https://wangdoc.com/javascript/dom/css#csssupports)
- [window.getComputedStyle()](https://wangdoc.com/javascript/dom/css#windowgetcomputedstyle)
- [CSS 伪元素](https://wangdoc.com/javascript/dom/css#css-伪元素)
- StyleSheet 接口
  - [概述](https://wangdoc.com/javascript/dom/css#概述)
  - [实例属性](https://wangdoc.com/javascript/dom/css#实例属性)
  - [实例方法](https://wangdoc.com/javascript/dom/css#实例方法)
- [实例：添加样式表](https://wangdoc.com/javascript/dom/css#实例添加样式表)
- [CSSRuleList 接口](https://wangdoc.com/javascript/dom/css#cssrulelist-接口)
- CSSRule 接口
  - [概述](https://wangdoc.com/javascript/dom/css#概述-1)
  - [CSSRule 实例的属性](https://wangdoc.com/javascript/dom/css#cssrule-实例的属性)
  - [CSSStyleRule 接口](https://wangdoc.com/javascript/dom/css#cssstylerule-接口)
  - [CSSMediaRule 接口](https://wangdoc.com/javascript/dom/css#cssmediarule-接口)
- window.matchMedia()
  - [基本用法](https://wangdoc.com/javascript/dom/css#基本用法)
  - [MediaQueryList 接口的实例属性](https://wangdoc.com/javascript/dom/css#mediaquerylist-接口的实例属性)
  - [MediaQueryList 接口的实例方法](https://wangdoc.com/javascript/dom/css#mediaquerylist-接口的实例方法)
...
```
解释var elem = document.getElementById('elem-container');
...
- [ 本文源码](https://raw.githubusercontent.com/wangdoc/javascript-tutorial/master/docs/dom/css.md)
