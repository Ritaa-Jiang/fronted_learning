...
[ JavaScript 教程](https://wangdoc.com/javascript/index.html)[语法专题](https://wangdoc.com/javascript/features/index.html)[数据类型的转换](https://wangdoc.com/javascript/features/conversion.html)
...
- [概述](https://wangdoc.com/javascript/features/conversion#概述)
- 强制转换
  - [Number()](https://wangdoc.com/javascript/features/conversion#number)
  - [String()](https://wangdoc.com/javascript/features/conversion#string)
  - [Boolean()](https://wangdoc.com/javascript/features/conversion#boolean)
- 自动转换
  - [自动转换为布尔值](https://wangdoc.com/javascript/features/conversion#自动转换为布尔值)
  - [自动转换为字符串](https://wangdoc.com/javascript/features/conversion#自动转换为字符串)
  - [自动转换为数值](https://wangdoc.com/javascript/features/conversion#自动转换为数值)
- [参考链接](https://wangdoc.com/javascript/features/conversion#参考链接)
...
`String`函数可以将**任意类型的值转化成字符串**，转换规则如下。
...
`String`方法的参数如果是**对象，返回一个类型字符串**；如果是**数组，返回该数组的字符串形式。**
...
- [ 本文源码](https://raw.githubusercontent.com/wangdoc/javascript-tutorial/master/docs/features/conversion.md)
