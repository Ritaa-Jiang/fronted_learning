...
[ JavaScript 教程](https://wangdoc.com/javascript/index.html)[语法专题](https://wangdoc.com/javascript/features/index.html)[错误处理机制](https://wangdoc.com/javascript/features/error.html)
...
- [Error 实例对象](https://wangdoc.com/javascript/features/error#error-实例对象)
- 原生错误类型
  - [SyntaxError 对象](https://wangdoc.com/javascript/features/error#syntaxerror-对象)
  - [ReferenceError 对象](https://wangdoc.com/javascript/features/error#referenceerror-对象)
  - [RangeError 对象](https://wangdoc.com/javascript/features/error#rangeerror-对象)
  - [TypeError 对象](https://wangdoc.com/javascript/features/error#typeerror-对象)
  - [URIError 对象](https://wangdoc.com/javascript/features/error#urierror-对象)
  - [EvalError 对象](https://wangdoc.com/javascript/features/error#evalerror-对象)
  - [总结](https://wangdoc.com/javascript/features/error#总结)
- [自定义错误](https://wangdoc.com/javascript/features/error#自定义错误)
- [throw 语句](https://wangdoc.com/javascript/features/error#throw-语句)
- [try...catch 结构](https://wangdoc.com/javascript/features/error#trycatch-结构)
- [finally 代码块](https://wangdoc.com/javascript/features/error#finally-代码块)
- [参考连接](https://wangdoc.com/javascript/features/error#参考连接)
...
- [ 本文源码](https://raw.githubusercontent.com/wangdoc/javascript-tutorial/master/docs/features/error.md)
