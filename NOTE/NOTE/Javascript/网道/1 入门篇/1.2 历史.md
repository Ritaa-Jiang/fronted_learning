...
[ JavaScript 教程](https://wangdoc.com/javascript/index.html)[入门篇](https://wangdoc.com/javascript/basic/index.html)[历史](https://wangdoc.com/javascript/basic/history.html)
...
- [诞生](https://wangdoc.com/javascript/basic/history#诞生)
- [JavaScript 与 Java 的关系](https://wangdoc.com/javascript/basic/history#javascript-与-java-的关系)
- [JavaScript 与 ECMAScript 的关系](https://wangdoc.com/javascript/basic/history#javascript-与-ecmascript-的关系)
- [JavaScript 的版本](https://wangdoc.com/javascript/basic/history#javascript-的版本)
- [周边大事记](https://wangdoc.com/javascript/basic/history#周边大事记)
- [参考链接](https://wangdoc.com/javascript/basic/history#参考链接)
...
- [ 本文源码](https://raw.githubusercontent.com/wangdoc/javascript-tutorial/master/docs/basic/history.md)
