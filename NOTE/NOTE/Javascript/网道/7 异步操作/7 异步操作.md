...
[ JavaScript 教程](https://wangdoc.com/javascript/index.html)[异步操作](https://wangdoc.com/javascript/async/index.html)[概述](https://wangdoc.com/javascript/async/general.html)
...
- [单线程模型](https://wangdoc.com/javascript/async/general#单线程模型)
- [同步任务和异步任务](https://wangdoc.com/javascript/async/general#同步任务和异步任务)
- [任务队列和事件循环](https://wangdoc.com/javascript/async/general#任务队列和事件循环)
- 异步操作的模式
  - [回调函数](https://wangdoc.com/javascript/async/general#回调函数)
  - [事件监听](https://wangdoc.com/javascript/async/general#事件监听)
  - [发布/订阅](https://wangdoc.com/javascript/async/general#发布订阅)
- 异步操作的流程控制
  - [串行执行](https://wangdoc.com/javascript/async/general#串行执行)
  - [并行执行](https://wangdoc.com/javascript/async/general#并行执行)
  - [并行与串行的结合](https://wangdoc.com/javascript/async/general#并行与串行的结合)
...
[ JavaScript 教程](https://wangdoc.com/javascript/index.html)[异步操作](https://wangdoc.com/javascript/async/index.html)[定时器](https://wangdoc.com/javascript/async/timer.html)
...
- [setTimeout()](https://wangdoc.com/javascript/async/timer#settimeout)
- [setInterval()](https://wangdoc.com/javascript/async/timer#setinterval)
- [clearTimeout()，clearInterval()](https://wangdoc.com/javascript/async/timer#cleartimeoutclearinterval)
- [实例：debounce 函数](https://wangdoc.com/javascript/async/timer#实例debounce-函数)
- [运行机制](https://wangdoc.com/javascript/async/timer#运行机制)
- setTimeout(f, 0)
  - [含义](https://wangdoc.com/javascript/async/timer#含义)
  - [应用](https://wangdoc.com/javascript/async/timer#应用)
...
[ JavaScript 教程](https://wangdoc.com/javascript/index.html)[异步操作](https://wangdoc.com/javascript/async/index.html)[Promise 对象](https://wangdoc.com/javascript/async/promise.html)
...
- [概述](https://wangdoc.com/javascript/async/promise#概述)
- [Promise 对象的状态](https://wangdoc.com/javascript/async/promise#promise-对象的状态)
- [Promise 构造函数](https://wangdoc.com/javascript/async/promise#promise-构造函数)
- [Promise.prototype.then()](https://wangdoc.com/javascript/async/promise#promiseprototypethen)
- [then() 用法辨析](https://wangdoc.com/javascript/async/promise#then-用法辨析)
- [实例：图片加载](https://wangdoc.com/javascript/async/promise#实例图片加载)
- [小结](https://wangdoc.com/javascript/async/promise#小结)
- [微任务](https://wangdoc.com/javascript/async/promise#微任务)
- [参考链接](https://wangdoc.com/javascript/async/promise#参考链接)
