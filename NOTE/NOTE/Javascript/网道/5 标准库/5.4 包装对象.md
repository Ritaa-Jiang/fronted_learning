...
[ JavaScript 教程](https://wangdoc.com/javascript/index.html)[标准库](https://wangdoc.com/javascript/stdlib/index.html)[包装对象](https://wangdoc.com/javascript/stdlib/wrapper.html)
...
- [定义](https://wangdoc.com/javascript/stdlib/wrapper#定义)
- 实例方法
  - [valueOf()](https://wangdoc.com/javascript/stdlib/wrapper#valueof)
  - [toString()](https://wangdoc.com/javascript/stdlib/wrapper#tostring)
- [原始类型与实例对象的自动转换](https://wangdoc.com/javascript/stdlib/wrapper#原始类型与实例对象的自动转换)
- [自定义方法](https://wangdoc.com/javascript/stdlib/wrapper#自定义方法)
...
- [ 本文源码](https://raw.githubusercontent.com/wangdoc/javascript-tutorial/master/docs/stdlib/wrapper.md)
