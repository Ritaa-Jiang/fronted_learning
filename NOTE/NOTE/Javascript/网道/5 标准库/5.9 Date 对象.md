...
[ JavaScript 教程](https://wangdoc.com/javascript/index.html)[标准库](https://wangdoc.com/javascript/stdlib/index.html)[Date 对象](https://wangdoc.com/javascript/stdlib/date.html)
...
- [普通函数的用法](https://wangdoc.com/javascript/stdlib/date#普通函数的用法)
- [构造函数的用法](https://wangdoc.com/javascript/stdlib/date#构造函数的用法)
- [日期的运算](https://wangdoc.com/javascript/stdlib/date#日期的运算)
- 静态方法
  - [Date.now()](https://wangdoc.com/javascript/stdlib/date#datenow)
  - [Date.parse()](https://wangdoc.com/javascript/stdlib/date#dateparse)
  - [Date.UTC()](https://wangdoc.com/javascript/stdlib/date#dateutc)
- 实例方法
  - [Date.prototype.valueOf()](https://wangdoc.com/javascript/stdlib/date#dateprototypevalueof)
  - [to 类方法](https://wangdoc.com/javascript/stdlib/date#to-类方法)
  - [get 类方法](https://wangdoc.com/javascript/stdlib/date#get-类方法)
  - [set 类方法](https://wangdoc.com/javascript/stdlib/date#set-类方法)
- [参考链接](https://wangdoc.com/javascript/stdlib/date#参考链接)
...
- [ 本文源码](https://raw.githubusercontent.com/wangdoc/javascript-tutorial/master/docs/stdlib/date.md)
